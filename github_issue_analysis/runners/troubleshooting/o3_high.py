"""O3 High reasoning troubleshooting runner."""
...
class O3HighTroubleshootRunner(GitHubIssueRunner):
    """O3 High reasoning troubleshooting analysis."""
