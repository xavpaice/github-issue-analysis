"""GPT-5 High reasoning troubleshooting runner."""
...
class GPT5HighTroubleshootRunner(GitHubIssueRunner):
    """GPT-5 High reasoning troubleshooting analysis."""
    ...
    def __init__(self) -> None:
        ...
        super().__init__("gpt5-high", agent)
